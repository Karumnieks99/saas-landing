...
export default function Integrations() {
  return (
    <section id="integrations" className="deferred-section space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="space-y-4">
          <div className="eyebrow">Deploy anywhere</div>
      ...
      <div className="section-frame p-0">
        <div className="grid gap-px bg-[var(--line)] xl:grid-cols-[0.95fr,1.05fr]">
          <div className="bg-[var(--surface-strong)] p-5 sm:p-6 lg:p-8">
            <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--muted)]">Systems around the workflow</p>
          ...
          <div className="bg-[var(--surface-strong)] p-5 sm:p-6 lg:p-8">
            <div className="demo-screen p-5">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  <p className="text-sm font-semibold text-[var(--panel-text)]">Example workflow</p>
                  <p className="mt-1 font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--muted)]">
                    Move scope change from inbox to invoice support
                  </p>
                </div>
              ...
              <div className="mt-6 space-y-3">
                {flow.map((step, index) => (
                  <div key={step.title} className="surface-card flex gap-4 p-4">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--accent-surface)] text-sm font-semibold text-[var(--accent)]">
                      0{index + 1}
                    </div>
                    <div>
                      <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--muted)]">{step.label}</p>
