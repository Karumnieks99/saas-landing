...
- Never use generic box shadows
- No gradients on interactive buttons
- Never pick a font not listed in this file
- Maintain the spacing scale exactly — no arbitrary px values
- No placeholder lorem ipsum in generated components
